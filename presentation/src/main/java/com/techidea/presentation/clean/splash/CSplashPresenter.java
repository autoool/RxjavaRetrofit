 ...
 */
public class CSplashPresenter implements CSplashContract.Presenter {

    private final CSplashContract.View mView;
    ...
    public CSplashPresenter(CSplashContract.View view,
